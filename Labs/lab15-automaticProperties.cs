/*
 * Name: Dmitry Landy
 * File: lab15b-automaticProperties-landy.cs
 * Date: 2/25/2021
 */
using System;
...
namespace AutomaticProperties
{
    class Program
    {
        static void doWork()
        {
            ...
            Polygon octagon = new Polygon { SideLength = 10, NumSides = 8 };
            Console.WriteLine($"Pentagon: number of sides is {octagon.NumSides}, length of each side is {octagon.SideLength}");
